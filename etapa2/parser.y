...
%%
	...
	;
	BLOCO_COMANDOS: '{'BLOCO_COMANDOS'}' | LISTA_COMANDOS
	;
	...
	;
	WHEN_THEN: KW_WHEN '('EXPRESSAO')' KW_THEN BLOCO_COMANDOS
	;
	WHEN_THEN_ELSE: KW_WHEN '(' EXPRESSAO ')' KW_THEN BLOCO_COMANDOS KW_ELSE BLOCO_COMANDOS
	;
	WHILE: KW_WHILE '(' EXPRESSAO ')' BLOCO_COMANDOS
	;
	FOR: KW_FOR '(' TK_IDENTIFIER '=' EXPRESSAO KW_TO EXPRESSAO ')' BLOCO_COMANDOS
	;
